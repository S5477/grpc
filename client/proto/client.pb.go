...
func (x *HelloMessage) GetSay() string {
	if x != nil {
		return x.Say
	}
	return ""
...
var file_proto_client_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x22, 0x20, 0x0a, 0x0c,
	0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x10, 0x0a, 0x03,
	0x73, 0x61, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x73, 0x61, 0x79, 0x22, 0x22,
	...
	0x52, 0x03, 0x6d, 0x73, 0x67, 0x32, 0x40, 0x0a, 0x06, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12,
	0x36, 0x0a, 0x05, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x14, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65,
...
var file_proto_client_proto_goTypes = []interface{}{
	(*HelloMessage)(nil),  // 0: server.HelloMessage
	(*HelloRequest)(nil),  // 1: server.HelloRequest
	(*HelloResponse)(nil), // 2: server.HelloResponse
}
var file_proto_client_proto_depIdxs = []int32{
	1, // 0: server.Server.Hello:input_type -> server.HelloRequest
	2, // 1: server.Server.Hello:output_type -> server.HelloResponse
